# Generated by Django 3.2.16 on 2023-06-27 16:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='created_at',
            field=models.DateTimeField(verbose_name='Добавлено', auto_now_add=True),
        ),
        migrations.AlterField(
            model_name='category',
            name='description',
        ...
        migrations.AlterField(
            model_name='post',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.location', verbose_name='Место положения'),
        ),
        migrations.AlterField(
            model_name='post',
            name='pub_date',
